...
CREATE TABLE IF NOT EXISTS maps (
    ...
    ht_mult REAL NOT NULL DEFAULT 0.25,
    ...
    sr_fl REAL NOT NULL,    
    sr_ht REAL NOT NULL,
    sr_htez REAL NOT NULL,
    sr_hthr REAL NOT NULL,
    sr_hrdt REAL NOT NULL,
    sr_ezdt REAL NOT NULL,
    sr_dtfl REAL NOT NULL,
    sr_hrfl REAL NOT NULL,
    sr_ezfl REAL NOT NULL,
    sr_htfl REAL NOT NULL,
    sr_hrdtfl REAL NOT NULL,
    sr_ezdtfl REAL NOT NULL,
    sr_hrhtfl REAL NOT NULL,
    sr_ezhtfl REAL NOT NULL
)                   
""")
